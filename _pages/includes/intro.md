...
His research interests include *3D reconstruction*, *medical image processing*, *video/salient object segmentation*, and *anomaly detection*. He has published some papers at the top international CV conferences and journals, such as **ICCV**, **CVPR**, **IEEE TIP**, **IEEE TCSVT**. He has served as a reviewer of **ECCV 2022** and **IEEE TCSVT**.
